                    ...
                    <li>
                        ...
                        <ul class="menus">
                            ...
                            @if(session('customer_id'))
                                <li>
                                    <a><i class="icon-user"></i>{{ session('customer_name') }}</a>
                                </li>
                                <li>
                                    <a href="{{ route('customer.logout', session('customer_id')) }}">Logout</a>
                                </li>
                            @else
                                <li class="login">
            ...
            <div class="row">
                <div class="col-auto col-lg-3 col-xl-3 col-xxl-2">
                    ...
                    <a href="{{ route('index') }}" class="logo">
                        <img src="{{ asset('assets/frontend/images/demos/demo-14/logo.png') }}" alt="Molla Logo"
                             width="105" height="25">
                    </a>
                                                ...
                                                <div class="product">
                                                    <div class="product-cart-details">
                                                        ...
                                                        <span class="cart-product-info">
                                                                <span
                                                                    class="cart-product-qty">{{ $item->quantity }}</span>
                                                                x &#2547; {{ $item->price }}
                                                            </span>
                                                    ...
                                                    <a href="{{ route('cart.destroy', $item->id) }}" class="btn-remove"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="banner banner-overlay">
                                                        <a href="category.html" class="banner banner-menu">
                                                            <img src="{{ asset('assets/frontend/images/demos/demo-13/menu/banner-1.jpg') }}" alt="Banner">
                                                        </a>
                                            ...
                                            @if(count($category->sub_cats) > 0 )
                                                <ul>
                                                    @foreach($category->sub_cats as $sub_category)
                                                        <li>
                                                            <a href="{{ route('cat.products', [$category->slug, $sub_category->slug]) }}"> {{ $sub_category->name }} </a>

                                                            @if(count($sub_category->sub_cats) > 0 )
                                                                <ul>
                                                                    @foreach($sub_category->sub_cats as $sub_sub_category)
                                                                        <li>
                                                                            <a href="{{ route('cat.products', [$category->slug, $sub_category->slug, $sub_sub_category->slug]) }}"> {{ $sub_sub_category->name }} </a>
                                                                        </li>
                                                                    @endforeach
                                                                </ul>
                                                            @endif
                                ...
                                <div class="megamenu megamenu-md">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-md-4">
                                            <div class="banner banner-overlay">
                                                <a href="category.html" class="banner banner-menu">
                                                    <img src="{{ asset('assets/frontend/images/menu/banner-1.jpg') }}"
                                                         alt="Banner">
