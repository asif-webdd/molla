...
<head>
    ...
    <link rel="mask-icon" href="{{ asset('assets/frontend/images/icons/safari-pinned-tab.svg') }}" color="#666666">
    <link rel="shortcut icon" href="{{ asset('assets/frontend/images/icons/favicon.ico') }}">
    ...
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/jquery.countdown.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/toastr.min.css') }}">
    <!-- Main CSS File -->
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/style.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/skin-demo-14.css') }}">
    <link rel="stylesheet" href="{{ asset('assets/frontend/css/demo-14.css') }}">
    @yield("CSS")
</head>
                            ...
                            <div class="tab-pane fade show active" id="signin" role="tabpanel" aria-labelledby="signin-tab">
                                <form action="{{ route('customer.login') }}" method="post">
                                    ...
                                    <div class="form-group">
                                        <label for="singin-email">Email or Mobile *</label>
...
<script src="{{ asset('assets/frontend/js/jquery.hoverIntent.min.js') }}"></script>
<script src="{{ asset('assets/frontend/js/jquery.waypoints.min.js') }}"></script>
<script src="{{ asset('assets/frontend/js/superfish.min.js') }}"></script>
<script src="{{ asset('assets/frontend/js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('assets/frontend/js/bootstrap-input-spinner.js') }}"></script>
<script src="{{ asset('assets/frontend/js/jquery.magnific-popup.min.js') }}"></script>
<script src="{{ asset('assets/frontend/js/jquery.plugin.min.js') }}"></script>
...
<script src="{{ asset('assets/frontend/js/demo-14.js') }}"></script>
