        ...
        <div class="row">
                    ...
                    <div class="intro-slider owl-carousel owl-simple owl-nav-inside" data-toggle="owl" data-owl-options='{
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="{{ asset('assets/frontend/images/demos/demo-14/slider/slide-1-480w.jpg') }}">
                                    <img src="{{ asset('assets/frontend/images/demos/demo-14/slider/slide-1.jpg') }}" alt="Image Desc">
                                </picture>
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="{{ asset('assets/frontend/images/demos/demo-14/slider/slide-2-480w.jpg') }}">
                                    <img src="{{ asset('assets/frontend/images/demos/demo-14/slider/slide-2.jpg') }}" alt="Image Desc">
                                </picture>
                            </figure><!-- End .slide-image -->
                        ...
                        <div class="intro-slide">
                            <figure class="slide-image">
                                <picture>
                                    <source media="(max-width: 480px)" srcset="{{ asset('assets/frontend/images/demos/demo-14/slider/slide-3-480w.jpg') }}">
                                    <img src="{{ asset('assets/frontend/images/demos/demo-14/slider/slide-3.jpg') }}" alt="Image Desc">
                                </picture>
                            </figure><!-- End .slide-image -->
            ...
            <div class="col-xl-3 col-xxl-2 d-none d-xxl-block">
                <div class="banner banner-overlay  banner-content-stretch ">
                    <a href="#">
                        <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-1.png') }}" alt="Banner img desc">
                    </a>
            ...
            <div class="col-xl-9 col-xxl-10">
                <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-2.jpg') }}" alt="Banner img desc">
                                    </a>
                            ...
                            <div class="col-md-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-3.png') }}" alt="Banner img desc">
                                    </a>
                    ...
                    <div class="col-12 col-xxl-5col d-none d-xxl-block">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-4.jpg') }}" alt="Banner img desc">
                            </a>
                ...
                <div class="owl-carousel owl-simple brands-carousel" data-toggle="owl"
                    ...
                    <a href="#" class="brand">
                        <img src="{{ asset('assets/frontend/images/brands/2.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('assets/frontend/images/brands/3.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('assets/frontend/images/brands/4.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('assets/frontend/images/brands/5.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('assets/frontend/images/brands/6.png') }}" alt="Brand Name">
                    </a>

                    <a href="#" class="brand">
                        <img src="{{ asset('assets/frontend/images/brands/7.png') }}" alt="Brand Name">
                    </a>
                    ...
                    <div class="tab-content tab-content-carousel">
                                ...
                                <div class="product text-center">
                                    ...
                                    <div class="product-body">
                                        ...
                                        <div class="product-price">
                                            ...
                                            <span class="old-price">Was &#2547; {{ $product->offer_price }}</span>
                        ...
                        <div class="tab-pane p-0 fade" id="trending-elec-tab" role="tabpanel" aria-labelledby="trending-elec-link">
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                                ...
                                @foreach($elec_product as $product)
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-sale">Sale</span>
                                            <a href="">
                        ...
                        <div class="tab-pane p-0 fade" id="trending-acc-tab" role="tabpanel" aria-labelledby="trending-acc-link">
                            <div class="owl-carousel owl-simple carousel-equal-height carousel-with-shadow" data-toggle="owl"
                                ...
                                @foreach($acce_product as $product)
                                    <div class="product text-center">
                                        <figure class="product-media">
                                            <span class="product-label label-sale">Sale</span>
                                            <a href="">
                ...
                <div class="row cat-banner-row electronics">
                    <div class="col-xl-3 col-xxl-4">
                        <div class="cat-banner row no-gutters">
                            <div class="cat-banner-list col-sm-6 d-xl-none d-xxl-flex" style="background-image: url({{ asset('assets/frontend/images/demos/demo-14/banners/banner-bg-1.jpg') }}">
                            ...
                            <div class="col-sm-6 col-xl-12 col-xxl-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-5.jpg') }}" alt="Banner img desc">
                                    </a>
                ...
                <div class="row cat-banner-row furniture">
                    <div class="col-xl-3 col-xxl-4">
                        <div class="cat-banner row no-gutters">
                            <div class="cat-banner-list col-sm-6 d-xl-none d-xxl-flex" style="background-image: url({{ asset('assets/frontend/images/demos/demo-14/banners/banner-bg-2.jpg') }}">
                                <div class="banner-list-content">
                            ...
                            <div class="col-sm-6 col-xl-12 col-xxl-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-6.jpg') }}" alt="Banner img desc">
                                    </a>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-7.jpg') }}" alt="Banner img desc">
                            </a>
                    ...
                    <div class="col-md-6">
                        <div class="banner banner-overlay">
                            <a href="#">
                                <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-8.jpg') }}" alt="Banner img desc">
                            </a>
                ...
                <div class="row cat-banner-row clothing">
                    <div class="col-xl-3 col-xxl-4">
                        <div class="cat-banner row no-gutters">
                            <div class="cat-banner-list col-sm-6 d-xl-none d-xxl-flex" style="background-image: url({{ asset('assets/frontend/images/demos/demo-14/banners/banner-bg-3.jpg') }}">
                                <div class="banner-list-content">
                            ...
                            <div class="col-sm-6 col-xl-12 col-xxl-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-9.jpg') }}" alt="Banner img desc">
                                    </a>
                    ...
                    <div class="col-xl-9 col-xxl-8">
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/products/product-14.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <span class="product-label label-new">New</span>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/products/product-15.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/products/product-16.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/products/product-17.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                ...
                <div class="row cat-banner-row cooking">
                    <div class="col-xl-3 col-xxl-4">
                        <div class="cat-banner row no-gutters">
                            <div class="cat-banner-list col-sm-6 d-xl-none d-xxl-flex" style="background-image: url({{ asset('assets/frontend/images/demos/demo-14/banners/banner-bg-4.jpg') }}">
                                <div class="banner-list-content">
                            ...
                            <div class="col-sm-6 col-xl-12 col-xxl-6">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-10.jpg') }}" alt="Banner img desc">
                                    </a>
                        ...
                        <div class="owl-carousel owl-full carousel-equal-height carousel-with-shadow" data-toggle="owl"
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <span class="product-label label-sale">Sale</span>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/products/product-18.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/products/product-19.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <a href="product.html">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/products/product-20.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                            ...
                            <div class="product text-center">
                                <figure class="product-media">
                                    <span class="product-label label-new">New</span>
                                    <a href="product.html">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/products/product-21.jpg') }}" alt="Product image" class="product-image">
                                    </a>
                    ...
                    <div class="row">
                        <div class="col-sm-6 col-xl-12">
                            <div class="widget widget-banner">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-11.jpg') }}" alt="Banner img desc">
                                    </a>
                            ...
                            <div class="widget widget-products">
                                ...
                                <div class="products">
                                    <div class="product product-sm">
                                        <figure class="product-media">
                                            <a href="product.html">
                                                <img src="{{ asset('assets/frontend/images/demos/demo-14/products/small/product-1.jpg') }}" alt="Product image" class="product-image">
                                            </a>
                                        </figure>
                                    ...
                                    <div class="col-sm-6 col-xl-12">
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                ...
                                                <a href="product.html">
                                                    <img src="{{ asset('assets/frontend/images/demos/demo-14/products/deals/product-1.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                                    ...
                                    <div class="col-sm-6 col-xl-12">
                                        <div class="product text-center">
                                            <figure class="product-media">
                                                <span class="product-label label-sale">Deal of the week</span>
                                                <a href="product.html">
                                                    <img src="{{ asset('assets/frontend/images/demos/demo-14/products/deals/product-2.jpg') }}" alt="Product image" class="product-image">
                                                </a>
                        ...
                        <div class="col-sm-6 col-xl-12">
                            <div class="widget widget-banner">
                                <div class="banner banner-overlay">
                                    <a href="#">
                                        <img src="{{ asset('assets/frontend/images/demos/demo-14/banners/banner-12.jpg') }}" alt="Banner img desc">
                                    </a>
                                ...
                                <div class="owl-carousel owl-simple" data-toggle="owl"
                                    ...
                                    <article class="entry">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="{{ asset('assets/frontend/images/demos/demo-14/blog/post-1.jpg') }}" alt="image desc">
                                            </a>
                                    ...
                                    <article class="entry">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="{{ asset('assets/frontend/images/demos/demo-14/blog/post-2.jpg') }}" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
                                    ...
                                    <article class="entry">
                                        <figure class="entry-media">
                                            <a href="single.html">
                                                <img src="{{ asset('assets/frontend/images/demos/demo-14/blog/post-3.jpg') }}" alt="image desc">
                                            </a>
                                        </figure><!-- End .entry-media -->
