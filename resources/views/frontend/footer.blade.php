<footer class="footer">
    <div class="cta cta-horizontal cta-horizontal-box bg-dark bg-image" style="background-image: url('{{ asset('assets/frontend/images/demos/demo-14/bg-1.jpg') }}">
            ...
            <div class="row">
                <div class="col-sm-12 col-lg-4">
                    <div class="widget widget-about">
                        <img src="{{ asset('assets/frontend/images/demos/demo-14/logo-footer.png') }}" class="footer-logo" alt="Footer Logo" width="105" height="25">
