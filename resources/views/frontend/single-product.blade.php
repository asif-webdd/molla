                                        ...
                                        <div class="row">
                                            ...
                                            <div id="product-zoom-gallery" class="product-image-gallery">
                                                <a class="product-gallery-item active" href="#"
                                                   ...
                                                   data-zoom-image="{{ $product->thumbnail }}">
                                                <img id="product-zoom"
                                                     src="{{ $product->thumbnail }}" style="height: 100%;"
                                                     data-zoom-image="{{ $product->thumbnail }}"
                                                     alt="product image">
                                                </a>
                                ...
                                <div class="tab-pane fade" id="product-shipping-tab" role="tabpanel"
                                    ...
                                    <div class="product-desc-content">
                                        ...
                                        <p>We deliver to over 100 countries around the world. For full details of the
                                            ...
                                            you
                                            can do so
                                            within a month of receipt. For full details of how to make a return, please
                                            view
                                            our <a
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="review-content">
                                                        <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit.
                                                            Ducimus
                                                            cum
                                                            dolores assumenda asperiores facilis porro reprehenderit
                                                            animi
                                                            culpa
                                                ...
                                                <div class="col">
                                                    ...
                                                    <div class="review-content">
                                                        <p>Sed, molestias, tempore? Ex dolor esse iure hic veniam
                                                            laborum
                                                            blanditiis
                                                            laudantium iste amet. Cum non voluptate eos enim, ab cumque
                                                            nam,
                                                            modi,
                                                            quas iure illum repellendus, blanditiis perspiciatis
                                                            beatae!</p>
                                                    </div><!-- End .review-content -->
                                    ...
                                    <div class="owl-item active" style="width: 277px; margin-right: 20px;">
                                        <div class="product product-7 text-center">
                                            ...
                                            <div class="product-body">
                                                ...
                                                <h3 class="product-title"><a href="product.html">Light brown studded
                                                        Wide
                                                        fit
...
@section('JS')
    <link rel="stylesheet" href="{{ asset('assets/frontend/js/jquery.elevateZoom.min.js') }}">
    <link rel="stylesheet" href="{{ asset('assets/frontend/js/nouislider.min.js') }}">
@endsection
