...
<head>
    ...
    <!--I-Check-->
    <link href="{{ asset('assets/admin/css/icheck.css') }}" rel="stylesheet"/>
...
<body>
<div id="wrapper">
    @include('admin.inc.left-panel')

    <div id="page-wrapper" class="gray-bg">
        @include('admin.inc.top-panel')
...
<!-- Flot -->
<script src="{{ asset('assets/admin/js/plugins/flot/jquery.flot.j') }}s"></script>
...
<!--Select Plugins-->
<link href="{{ asset('assets/admin/js/select2.full.min.js') }}" rel="stylesheet"/>

<!--I-Check-->
<link href="{{ asset('assets/admin/js/icheck.min.js') }}" rel="stylesheet"/>

<!--Date Picker-->
<link href="{{ asset('assets/admin/js/bootstrap-datepicker.js') }}" rel="stylesheet"/>
